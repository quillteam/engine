...
ConVar snd_cull_duplicates("snd_cull_duplicates","0", FCVAR_ARCHIVE,"If nonzero, aggressively cull duplicate sounds during mixing. The number specifies the number of duplicates allowed to be played.");
