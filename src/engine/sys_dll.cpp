...
ConVar mem_min_heapsize( "mem_min_heapsize", "48", FCVAR_DEVELOPMENTONLY, "Minimum amount of memory to dedicate to engine hunk and datacache (in mb)" );
ConVar mem_max_heapsize( "mem_max_heapsize", "256", FCVAR_DEVELOPMENTONLY, "Maximum amount of memory to dedicate to engine hunk and datacache (in mb)" );
ConVar mem_max_heapsize_dedicated( "mem_max_heapsize_dedicated", "64", FCVAR_DEVELOPMENTONLY, "Maximum amount of memory to dedicate to engine hunk and datacache, for dedicated server (in mb)" );
